  ...
  return (
    <>
      ...
      >
        ...
        <div className="md:grid md:grid-cols-9 grid-cols-1 gap-2 space-x-4">
          <div className="md:pl-12 md:flex-col md:col-span-4">
        ...
        <div className="md:pl-12 md:col-span-4 pt-4">
          <div className="">
            <b>How it works:</b>
          </div>
          <p className="pb-2">
